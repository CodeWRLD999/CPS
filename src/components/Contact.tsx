        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          <div className="lg:col-span-2 space-y-4">
            ...
            >
              ...
              <div className="text-black/70 text-xs font-bold tracking-[0.2em] uppercase mb-1">
                Call Us Direct
              </div>
              <div className="text-black font-black text-3xl tracking-tight">
                07888 845 786
              </div>
            ...
            >
              ...
              <div className="text-white/50 text-xs font-bold tracking-[0.2em] uppercase mb-1">
                Email
              </div>
              <div className="text-white font-bold text-sm break-all">
                info@cpscompletepropertysolutions.co.uk
              </div>
            </a>
            ...
            {done ? (
              <div className="flex flex-col items-center justify-center text-center py-16">
                ...
                <p className="text-white/60 mb-8 max-w-md">
                  Thanks for reaching out. We'll review your enquiry and get back to you within 24 hours. For urgent jobs, please call us directly.
                </p>
              ...
              <form onSubmit={submit} className="space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-white/70 text-xs font-bold tracking-wide uppercase mb-2">
                      Your Name *
                    </label>
                    <input
                      name="name"
