...
const ABOUT_IMG = 'https://d64gsuwffb70l.cloudfront.net/69f4ae5bb9f1d161422c55b2_1777643212526_05f31367.jpg';
...
const About: React.FC = () => {
  return (
    <section id="about" className="relative py-24 sm:py-32 bg-[#05090a]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 lg:order-2">
            <div className="inline-flex items-center gap-3 mb-5">
              ...
              <span className="text-[#f58200] text-xs font-bold tracking-[0.3em] uppercase">About Us</span>
            </div>
            <h2 className="text-4xl sm:text-5xl font-black text-white leading-tight tracking-tight mb-6">
              Built On Trust,<br />Delivered With <span className="text-[#f58200]">Pride</span>
            </h2>
