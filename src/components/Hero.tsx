...
const Hero: React.FC = () => {
  return (
    ...
    >
      {/* Background image - NEVER in normal page flow */}
      <div className="absolute inset-0 -z-30 bg-[#05090a]">
        <img
          src="/picture2.png"
          alt=""
          aria-hidden="true"
      ...
      <div className="absolute inset-0 -z-20 bg-gradient-to-r from-[#05090a] via-[#05090a]/90 to-[#05090a]/65" />
      <div className="absolute inset-0 -z-10 bg-[#05090a]/35 md:bg-transparent" />
